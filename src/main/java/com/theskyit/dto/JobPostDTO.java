...
public class JobPostDTO {
    ...
    @Size(max = 500, message = "Job Description should be less than 500 characters")
	...
	public JobPostDTO(@NotNull(message = "Job Title cannot be null") String jobTitle,
			...
			@Size(max = 500, message = "Job Description should be less than 500 characters") String jobDescription,
			@Min(value = 0, message = "Minimum Experience cannot be negative") int minimumExperience,
